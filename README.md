...
In our experimental process, we focused on seven subjects from Defects4J(V2.0.0) [Defects4J](https://github.com/rjust/defects4j) and 374 Python programs from [ConDefects](https://github.com/appmlk/ConDefects), with a total of 661 faulty programs:
